...
{
    public partial class frmIssueBrgyIndigency : Form
    {
        public frmIssueBrgyIndigency()
        {
            InitializeComponent();
        }

        private void frmIssueBrgyIndigency_Load(object sender, EventArgs e)
        {
            LoadData();
        }
        ...
        private void btnGenerate_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.ColumnIndex == 3)
            {
                MessageBox.Show("Generate Barangay Indigency");
            }
        }
    }
}
